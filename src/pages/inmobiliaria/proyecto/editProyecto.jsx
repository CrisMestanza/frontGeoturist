...
export default function EditProyectoModal({
  ...
  const [form, setForm] = useState({
    ...
    puntos: [],
    imagenes: [],
    precio_entrada: proyecto?.precio_entrada || "",
    horario_apertura: proyecto?.horario_apertura || "",
    horario_cierre: proyecto?.horario_cierre || "",
    tiene_restaurante: proyecto?.tiene_restaurante ? 1 : 0,
    tiene_bebidas: proyecto?.tiene_bebidas ? 1 : 0,
    breve_descripcion: proyecto?.breve_descripcion || "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("precio_entrada", Number(form.precio_entrada) || 0);
      if (form.horario_apertura) formData.append("horario_apertura", form.horario_apertura);
      if (form.horario_cierre) formData.append("horario_cierre", form.horario_cierre);
      formData.append("tiene_restaurante", form.tiene_restaurante === "1" || form.tiene_restaurante === 1 ? true : false);
      formData.append("tiene_bebidas", form.tiene_bebidas === "1" || form.tiene_bebidas === 1 ? true : false);
      if (form.breve_descripcion) formData.append("breve_descripcion", form.breve_descripcion);
      if (form.idcategoria) formData.append("idcategoria", form.idcategoria);
    ...
    <div className={styles.modalOverlay}>
      <div className={styles.modalContent}>
        <div className={styles.header}>
          <div>
            <h1 className={styles.title}>Editar Centro Turístico</h1>
            <p className={styles.subtitle}>
              Actualiza datos del centro turístico, imágenes y área del polígono.
            </p>
          </div>
            ...
            <div className={styles.leftColumn}>
              <section>
                ...
                <div className={styles.inputGroup}>
                  <label>Categoría del centro turístico</label>
                  <select
                    name="idcategoria"
